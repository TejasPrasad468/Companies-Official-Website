...
// Recent Project Title Color
$wp_customize->add_setting( 'complete[reproj_title_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_title_color_id', array(
	'label' => __('Recent Project Title Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_title_color_id]',
) ) );

// Recent Project Company Color
$wp_customize->add_setting( 'complete[reproj_comp_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_comp_color_id', array(
	'label' => __('Recent Project Company Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_comp_color_id]',
) ) );

// Recent Project Button Text Color
$wp_customize->add_setting( 'complete[reproj_btntext_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_btntext_color_id', array(
	'label' => __('Recent Project Button Text Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_btntext_color_id]',
) ) );

// Recent Project Button Background Color
$wp_customize->add_setting( 'complete[reproj_btnbg_color_id]', array(
	'type' => 'option',
	'default' => '#2f5bea',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_btnbg_color_id', array(
	'label' => __('Recent Project Button Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_btnbg_color_id]',
) ) );

// Recent Project Button Hover Text Color
$wp_customize->add_setting( 'complete[reproj_btnhtext_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_btnhtext_color_id', array(
	'label' => __('Recent Project Button Hover Text Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_btnhtext_color_id]',
) ) );

// Recent Project Button Hover Background Color
$wp_customize->add_setting( 'complete[reproj_btnhbg_color_id]', array(
	'type' => 'option',
	'default' => '#66e0c9',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_btnhbg_color_id', array(
	'label' => __('Recent Project Button Hover Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_btnhbg_color_id]',
) ) );

// Recent Project Image Hover Background Color
$wp_customize->add_setting( 'complete[reproj_imgbg_color_id]', array(
	'type' => 'option',
	'default' => '#66e0c9',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_imgbg_color_id', array(
	'label' => __('Recent Project Image Hover Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_imgbg_color_id]',
) ) );

// Recent Project Arrow Background Color
$wp_customize->add_setting( 'complete[reproj_navbg_color_id]', array(
	'type' => 'option',
	'default' => '#222222',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_navbg_color_id', array(
	'label' => __('Recent Project Arrow Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_navbg_color_id]',
) ) );

// Recent Project Arrow Color
$wp_customize->add_setting( 'complete[reproj_nav_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_nav_color_id', array(
	'label' => __('Recent Project Arrow Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_nav_color_id]',
) ) );

// Recent Project Arrow Hover Background Color
$wp_customize->add_setting( 'complete[reproj_navhbg_color_id]', array(
	'type' => 'option',
	'default' => '#2f5bea',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_navhbg_color_id', array(
	'label' => __('Recent Project Arrow Hover Background Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_navhbg_color_id]',
) ) );

// Recent Project Arrow Color
$wp_customize->add_setting( 'complete[reproj_navh_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reproj_navh_color_id', array(
	'label' => __('Recent Project Arrow Hover Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[reproj_navh_color_id]',
) ) );
