...
$wp_customize->add_setting('complete[phntp_text_id]', array(
	'type' => 'option',
	'default' => __('<i class="fa fa-map-marker" aria-hidden="true"></i> E102 Lorem Ben Street, London, United Kingdom','complete'),
...
$wp_customize->add_setting( 'complete[donatbtn_color_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'donatbtn_color_id', array(
				'label' => __('Donate Button Text Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[donatbtn_color_id]',
			) ) );

//DONATE BUTTON BACKGROUND COLOR
$wp_customize->add_setting( 'complete[donatbtn_bgcolor_id]', array(
	'type' => 'option',
	'default' => '#2f5bea',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'donatbtn_bgcolor_id', array(
				'label' => __('Donate Button Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[donatbtn_bgcolor_id]',
			) ) );
//DONATE BUTTON HOVER TEXT COLOR
$wp_customize->add_setting( 'complete[donatbtn_hcolor_id]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'donatbtn_hcolor_id', array(
				'label' => __('Donate Button Hover Text Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[donatbtn_hcolor_id]',
			) ) );

//DONATE BUTTON HOVER BACKGROUND COLOR
$wp_customize->add_setting( 'complete[donatbtn_hbgcolor_id]', array(
	'type' => 'option',
	'default' => '#222222',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'donatbtn_hbgcolor_id', array(
				'label' => __('Donate Button Hover Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[donatbtn_hbgcolor_id]',
			) ) );
