...
//----------------------FRONT CONTENT SECTION----------------------------------
	$ImageIconUrl = esc_url(get_template_directory_uri() ."/images/slide-hero-img.png");
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_link4_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link4_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 4','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link4_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn4_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn4_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 4','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn4_2]',
	)) );
	// Slide 4 End
	...
	$wp_customize->add_setting('complete[slide_link5_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link5_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 5','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link5_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn5_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn5_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 5','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn5_2]',
	)) );
	// Slide 5 End
	// Slide 6 Start
	...
	$wp_customize->add_setting('complete[slide_link6_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link6_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 6','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link6_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn6_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn6_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 6','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn6_2]',
	)) );
	// Slide 6 End
	// Slide 7 Start
	...
	$wp_customize->add_setting('complete[slide_link7_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link7_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 7','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link7_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn7_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn7_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 1','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn7_2]',
	)) );
	// Slide 7 End
	// Slide 8 Start
	...
	$wp_customize->add_setting('complete[slide_link8_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link8_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 8','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link8_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn8_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn8_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 8','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn8_2]',
	)) );
	// Slide 8 End
	// Slide 9 Start
	...
	$wp_customize->add_setting('complete[slide_link9_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link9_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 9','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link9_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn9_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn9_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 9','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn9_2]',
	)) );
	// Slide 9 End
	...
	$wp_customize->add_setting('complete[slide_link10_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_link10_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Link 10','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_link10_2]',
	)) );	
	
	$wp_customize->add_setting('complete[slide_btn10_2]', array(
		'type' => 'option',
		'default'	=> __('','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	$wp_customize->add_control(	new WP_Customize_Text_Control( $wp_customize, 'slide_btn10_2', array( 
		'type' => 'text',
		'label'	=> __('Discover More Button 10','complete'),
		'section' => 'slider_section',
		'settings' => 'complete[slide_btn10_2]',
	)) );
	// Slide 10 End									
