...
function complete_option_defaults() {
	$defaults = array(
		...
		'totop_id' => '1',
		'footer_text_id' => __('<div class="copyright-center">&copy; 2019 SKT Ele Product Launch. All Rights Reserved  -  Powered by sktthemes.org</div>', 'complete'),
