...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('<small>We Are Providing Best</small>Business Service','complete'),
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('Faucibus orci luctus et ultposuere cubilia Curaei Duis maurisey.','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
