...
$wp_customize->add_setting('complete[header_mobile_number]', array(
	'type' => 'option',
	'default' => __('<img src="'.get_template_directory_uri().'/images/phone-icon.png">123 - 456 - 7890','complete'),
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
//Header mobile number color
$wp_customize->add_setting( 'complete[header_mobile_number_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_mobile_number_color', array(
				'label' => __('Header Mobile Number Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[header_mobile_number_color]',
			) ) );
